...
if _name_ == '_main_':
    ...
    while True:
        ...
        if 'wikipedia summary' in query:
            ...
            strTime = datetime.datetime.now().strftime("%H: %M: %S %a")
            ...
            whatsapp_message = input('Type a message')
            time_hour = datetime.datetime.now().hour
            time_min = datetime.datetime.now().min
            pywhatkit.sendwhatmsg(f"+91{contact}", whatsapp_message, 23, 8)
            ...
            speak("I have been created by Arc")
